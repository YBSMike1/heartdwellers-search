...
if dark_mode:
    ...
    <style>
        ...
        h1, h2, h3, p, label, .stMarkdown, .stText, .stSuccess, .stInfo { color: #1a1a1a !important; }
        .stTextInput input { color: #000000 !important; background: #ffffff !important; border: 2px solid #555 !important; }
